...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_deptauth';
		$primarykey = 'deptauth_id';
		...
		try {
			...
			$obj->deptauth_name = strtoupper($obj->deptauth_name);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'deptauth_id', 'deptauth_name', 'deptauth_isdisabled', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
