	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('mst_dept', [
				'dept_id', 'dept_name', 'dept_descr', 'dept_isparent', 'dept_isdisabled', 'dept_path', 'dept_level', 'deptgroup_id', 'dept_parent', 'depttype_id', 'deptauth_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
