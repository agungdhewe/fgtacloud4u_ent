...
const obj = {
	txt_brandtype_id: $('#pnl_edit-txt_brandtype_id'),
	txt_brandtype_name: $('#pnl_edit-txt_brandtype_name'),
	txt_brandtype_descr: $('#pnl_edit-txt_brandtype_descr')
}
...
function form_idsetup(options) {
	var objid = obj.txt_brandtype_id
