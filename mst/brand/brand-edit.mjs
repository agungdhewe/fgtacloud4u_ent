...
const obj = {
	...
	txt_brand_name: $('#pnl_edit-txt_brand_name'),
	txt_brand_descr: $('#pnl_edit-txt_brand_descr'),
...
export async function init(opt) {
	...
	new fgta4slideselect(obj.cbo_brandtype_id, {
		title: 'Pilih brandtype_id',
		returnpage: this_page_id,
		api: $ui.apis.load_brandtype_id,
		fieldValue: 'brandtype_id',
		fieldValueMap: 'brandtype_id',
		fieldDisplay: 'brandtype_name',
		fields: [
