...
module.exports = {
	...
	persistent: {
		'mst_brand' : {
			...
			values: [
				{brand_id:'HBS', brand_name:'HUGOBOSS', brandtype_id:'MEN'},
				{brand_id:'CAN', brand_name:'CANALI', brandtype_id:'MEN'},
				{brand_id:'GEX', brand_name:'GEOX', brandtype_id:'MEN'},
				{brand_id:'EAG', brand_name:'AIGNER', brandtype_id:'ACS'},
				{brand_id:'FLA', brand_name:'FURLA', brandtype_id:'ACS'},
				{brand_id:'FRG', brand_name:'FERRAGAMO', brandtype_id:'ACS'},
				{brand_id:'FKP', brand_name:'FIND KAPOOR', brandtype_id:'ACS'},
				{brand_id:'TOD', brand_name:'TODS', brandtype_id:'ACS'},
			],
