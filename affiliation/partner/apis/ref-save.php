...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->partnerref_id = strtoupper($obj->partnerref_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'partnerref_id', 'interface_id', 'partnerref_code', 'partner_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'interface_name' => \FGTA4\utils\SqlUtility::Lookup($data->interface_id, $this->db, 'mst_interface', 'interface_id', 'interface_name'),
