...
const obj = {
	txt_partnersite_id: $('#pnl_editsiteform-txt_partnersite_id'),
	cbo_site_id: $('#pnl_editsiteform-cbo_site_id'),
	txt_partner_id: $('#pnl_editsiteform-txt_partner_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_partnersite_id,
		autoid: true,
		logview: 'mst_partnersite',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_partnersite_id
