...
class DataSave extends WebAPI {
	function __construct() {
		$logfilepath = __LOCALDB_DIR . "/output/partnertype-save.txt";
		// debug::disable();
	...
	public function execute($data, $options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'partnertype_id', 'partnertype_name', 'partnertype_descr', 'partnertype_isempl', 'partnertype_isdisabled', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
