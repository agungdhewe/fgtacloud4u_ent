...
const obj = {
	...
	txt_config_name: $('#pnl_edit-txt_config_name'),
	txt_config_dir: $('#pnl_edit-txt_config_dir'),
	txt_config_filename: $('#pnl_edit-txt_config_filename')
}
